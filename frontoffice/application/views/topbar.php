	...
	<div id="content">
		...
		<nav class="navbar navbar-expand navbar-light bg-white topbar mb-3 static-top shadow">
			...
			<div class="topbar-welcome ml-2 text-gray-600">
				<i class="fas fa-calendar-alt"></i>&nbsp; <span id="top-info-date" class="top-info-date"></span>&nbsp; | &nbsp;<span class="mb-0 ">Halo, Admin Front Office !</span>
			</div>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown no-arrow">
					<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $fo['nama'] ?></span>
						<img class="img-profile rounded-circle" src="<?= base_url(); ?>../assets/dashboard/images/frontoffice/profil/<?= $fo['foto_profil_fo'] ?>">
					</a>

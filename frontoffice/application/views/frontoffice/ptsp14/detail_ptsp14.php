...
<div class="container-fluid">
	...
	<div class="row clearfix">
		...
		<div class="col-md-8 mb-4">
			...
			<div class="row clearfix">
				<div class="col-md-12">
					<form class="form-horizontal" id="no_surat_ptsp14" enctype="multipart/form-data"
						...
						<div class="row clearfix">
							...
							<div class="input-group col-md-6 px-2 mb-2">
								<input type="text" class="form-control " id="no_surat" name="no_surat"
									value=".../Kk.11.10/.../PP.00.1/bln/thn" required>
							</div>
							<div class="input-group col-md-3 px-2 mb-2">
								<input type="text" class="form-control " id="masa_berlaku" name="masa_berlaku" placeholder="masa berlaku" value=""
									required>
							</div>

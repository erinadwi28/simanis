        ...
        <div class="container-fluid">
          ...
          <div class="judullist">
            <center>
              <h3>Halaman Utama Front Office</h3>
            </center>
          </div>
              ...
              <div class="card border-left-danger shadow h-100 p-0">
                <div class="card-body px-3 py-3 ">
                  ...
                  <div class="row mt-3">
                    <div class="col-md-12">
                        <a href=""
                          class="btn btn-danger float-right"><i class="far fa-eye nav-icon"></i> Tampilkan</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body px-3 py-3 ">
                  ...
                  <div class="row mt-3">
                    <div class="col-md-12">
                      <center>
                        <a href=""
                        class="btn btn-success float-right"><i class="far fa-eye nav-icon"></i> Tampilkan</a>
                      </center>
                    </div>
                  </div>
                </div>
              ...
              <div class="card border-left-success shadow h-100 p-0">
                <div class="card-body px-3 py-3 ">
                  ...
                  <div class="row mt-3">
                    <div class="col-md-12">
                        <a href=""
                          class="badge badge-warning float-right">Selengkapnya <i class="fas fa-arrow-right"></i></a>
                    </div>
                  </div>
                </div>
              </div>

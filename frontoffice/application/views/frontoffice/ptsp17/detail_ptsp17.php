...
<div class="container-fluid">
	...
	foreach ($detail_ptsp as $detail) {
				...
				<div class="card shadow">
					...
					<div class="card-body">
						<table class="table-hover table-responsive">
							<tbody>
								<?php
								if ($detail->no_surat != null && $detail->status == 'Selesai') { ?>
									<tr>
			...
			<div class="col-xs-12 col-sm-3 mr-5">
				...
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						<center>
							<?php
							if ($detail->srt_persetujuan_sekolah_satmikal != null) { ?>
			...
			<div class="col-xs-12 col-sm-3">
				...
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						<center>
							<?php
							if ($detail->srt_persetujuan_sekolah_tujuan != null) { ?>
		...
		if ($detail->status == 'Selesai') { ?>
			<div class="row clearfix">
				<div class="col-md-12">
					<form class="form-horizontal" id="no_surat_ptsp17" enctype="multipart/form-data" action="<?= base_url() ?>dashboard/aksi_update_status_setujui/<?= $detail->id_permohonan_ptsp ?>/<?= $detail->id_layanan ?>" method="POST">
						<div class="row clearfix">
							...
							<div class="input-group col-md-3 px-2 mb-2">
								<input type="text" class="form-control " id="no_surat" name="no_surat" value=".../Kk.11.10/1/KP.07.6/bln/tahun" required>
							</div>

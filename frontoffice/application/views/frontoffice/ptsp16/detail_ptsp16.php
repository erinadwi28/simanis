		...
		<div class="row clearfix">
			...
			<div class="col-md-8 mb-4">
				...
				<?php if ($detail->status === 'Selesai' && $detail->no_surat == null) { ?>
					<div class="row clearfix">
						<div class="col-md-12">
							<form class="form-horizontal" id="no_surat_ptsp16" enctype="multipart/form-data" action="<?= base_url() ?>dashboard/aksi_update_pengajuan_ptsp16/<?= $detail->id_permohonan_ptsp ?>" method="POST">
								<div class="row clearfix">
									<div class="col-md-1"></div>
									<div class="input-group col-md-3 px-2 mb-2">
										<input type="text" class="form-control " id="no_surat" name="no_surat" value=".../Kk.11.10/03/PP.00.11/<?= date("m/Y") ?>" required>
									</div>
									<div class="input-group col-md-3 px-2 mb-2">

		...
		<div class="row clearfix">
			...
			<div class="col-md-8 mb-0">
				...
				if ($detail->status == 'Selesai') { ?>
					<div class="row clearfix">
						<div class="col-md-12">
							<form class="form-horizontal" id="no_surat_ptsp18" enctype="multipart/form-data" action="<?= base_url() ?>dashboard/aksi_update_status_setujui/<?= $detail->id_permohonan_ptsp ?>/<?= $detail->id_layanan ?>" method="POST">
								<div class="row clearfix">
									<div class="col-md-1"></div>
									<div class="input-group col-md-3 px-2 mb-2">
									</div>
									<div class="input-group col-md-6 px-2 mb-2">
										<input type="text" class="form-control " id="no_surat" name="no_surat" value=".../Kk.11.10/6/HM.01/bln/tahun" required>
									</div>

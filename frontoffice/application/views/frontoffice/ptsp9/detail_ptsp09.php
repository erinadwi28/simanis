...
<div class="container-fluid">
	...
	foreach ($detail_ptsp as $detail) {
		...
		if ($detail->status === 'Selesai') { ?>
			<div class="row clearfix">
				<div class="col-md-12">
					<form class="form-horizontal" id="no_surat_ptsp09" enctype="multipart/form-data" action="<?= base_url() ?>dashboard/aksi_update_pengajuan_ptsp09/<?= $detail->id_permohonan_ptsp ?>" method="POST">

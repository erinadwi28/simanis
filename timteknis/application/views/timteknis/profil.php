	...
	<div class="row">
		<div class="col-md-4 mb-4">
			...
			<div class="card shadow mb-4">
				...
				<center>
					<div class="card-body">
						<img src="<?= base_url(); ?>../assets/dashboard/images/timteknis/profil/<?= $tim_teknis['foto_profil_tim_teknis'] ?>"
				...
				<div class="card-footer py-3">
					<form action="<?= base_url('dashboard/upload_foto_profil') ?>" enctype="multipart/form-data"

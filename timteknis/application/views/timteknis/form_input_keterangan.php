					...
					<div class="preview mt-0">
						<center>
                            ...
                            <em class="float-center small text-danger">*Masukkan keterangan dengan lengkap dan jelas, keterangan ini akan
								...
								<form role="form" action="<?= base_url('dashboard/kirim_alasn_permohonan') ?>"
									method="post" id="formketerangan">
									<div class="form-row align-items-center">
										<div class="col-md-2"></div>
										<div class="col-md-8 mt-4 mb-2">
											<div class="form-group-surat">
												<textarea type="text" class="form-control mb-2" name="keterangan"
													id="keterangan"
											...
											<input type="hidden" class="form-control form-user-input"
												...
												value="<?= $id_permohonan_ptsp['id_permohonan_ptsp']; ?>">
											<input type="hidden" class="form-control form-user-input" name="id_pemohon"
												id="id_pemohon" value="<?= $id_permohonan_ptsp['id_pemohon']; ?>">
										</div>
										<div class="col-md-2"> </div>
									</div>
									<div class="form-row align-items-center">

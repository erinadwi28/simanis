		...
		<div class="row clearfix">
			...
			<div class="col-md-4 mb-0">
				...
				<div class="card shadow mb-4">
					...
					<?php if ($detail->status == 'Proses Tim Teknis') { ?>
						<div class="card-footer">
							<form action="<?= base_url('dashboard/upload_berita_acaraptsp20/' . $detail->id_ptsp) ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="berita_acara">
			...
			<div class="col-md-8 mb-0">
				...
				<?php if ($detail->status == 'Proses Tim Teknis') { ?>
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form class="form-horizontal mt-4" id="formba_ptsp14" enctype="multipart/form-data" action="<?= base_url('dashboard/update_no_statistik_ptsp20/' . $detail->id_ptsp) ?>" method="POST">
								<div class="form-group row">
									<label for="no_statistik" class="col-sm-2 col-form-label">No. Statistik</label>
									<div class="col-sm-8 ml-1">
										<div class="form-line focused">
											<input type="text" class="form-control" id="no_statistik" name="no_statistik" value="" placeholder="masukkan no statistik verifikasi dok disini..." required>
										</div>
									</div>
								</div>
								<input type="hidden" class="form-control form-user-input" name="id_permohonan_ptsp" id="file-upload" value="<?= $detail->id_permohonan_ptsp ?>">

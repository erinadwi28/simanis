			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<center>
						...
						<a id="btn_upload" class="btn btn-sm btn-primary"
							href="<?= base_url() ?>../assets/dashboard/pemohon/ptsp/ptsp10/berita_acara/<?= $detail->berita_acara ?>"
							target="_blank">
				...
				<div class="card-footer">
					<form action="<?= base_url('dashboard/upload_berita_acaraptsp10/' . $detail->id_ptsp) ?>"
						enctype="multipart/form-data" method="post" accept-charset="utf-8"
						id="formupload_berita_acara_10">

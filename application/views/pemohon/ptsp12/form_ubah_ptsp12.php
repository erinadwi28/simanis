...
<?php foreach ($detail_ptsp as $detail) { ?>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4 judullist">
		<h3>Form Ubah Permohonan</h3>
				<a href="<?= base_url() ?>dashboard/detail_ptsp12/<?= $detail->id_permohonan_ptsp ?>">
	...
	<div class="row clearfix">
		...
		<div class="col-xs col-sm-8">
			<div class="card shadow mb-5">
				...
				<div class="card-body">
					<form class="form-horizontal" id="formubah_ptsp12" enctype="multipart/form-data" 
						action="<?= base_url() ?>dashboard/aksi_update_pengajuan_ptsp12/<?= $detail->id_permohonan_ptsp ?>" method="POST">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="nama_tujuan" name="nama_tujuan" 
										value="<?= $detail->nama_tujuan ?>" placeholder="masukkan nama tujuan (cth. Gubernur Jawa Tengah) disini..."
										required>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="tempat_tujuan" name="tempat_tujuan"
										value="<?= $detail->tempat_tujuan ?>" placeholder="masukkan tempat tujuan (cth. Semarang) disini..."
										required>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah"
										value="<?= $detail->nama_sekolah ?>" placeholder="masukkan nama sekolah disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<textarea type="text" class="form-control" id="keperluan" name="keperluan" value=""
										placeholder="masukkan keperluan disini..." required><?= $detail->keperluan ?></textarea>
								</div>
							</div>
						</div>
						<div class="form-group row">

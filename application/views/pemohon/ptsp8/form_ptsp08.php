					...
					<div class="card-body">
						...
						<form class="form-horizontal mt-4" id="form_ptsp08" enctype="multipart/form-data" action="<?= base_url('dashboard/aksi_pengajuan_ptsp08') ?>" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<textarea type="text" class="form-control" id="domisili_kelompok_bimbingan" name="domisili_kelompok_bimbingan" value="" placeholder="masukkan domisili kel.bimbingan disini..." required></textarea>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<textarea type="text" class="form-control" id="alamat_kantor" name="alamat_kantor" value="" placeholder="masukkan alamat kantor disini..." required></textarea>
									</div>
								</div>
							</div>
							<div class="form-group row">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ol type="1" class="ml-0 list-syarat modal-content-syarat">
					<li>Pemohon mengunduh Surat Permohonan, unduh dengan <b><a href="<?= base_url() ?>assets/pemohon/sop/ptsp08/srt_permohonan.pdf" target="_blank">[klik disini]</a></b></li>
					...
					<li>Pemohon mengunggah bukti foto kantor sekretariat tetap dan ruang kegiatan bimbingan.
						<br> (Format: PDF, Ukuran: Max 10 MB)
					</li>

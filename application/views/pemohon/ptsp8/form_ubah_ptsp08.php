...
<div class="container-fluid">
	...
	<?php foreach ($detail_ptsp as $detail) { ?>
		...
		<div class="d-sm-flex align-items-center justify-content-between mt-4 mb-4 judullist">
			...
			<a href="<?= base_url() ?>dashboard/detail_ptsp08/<?= $detail->id_permohonan_ptsp ?>">
		...
		<div class="row clearfix">
			...
			<div class="col-xs col-sm-8">
				<div class="card shadow mb-5">
					...
					<div class="card-body">
						<form class="form-horizontal" id="formubah_ptsp07" enctype="multipart/form-data" action="<?= base_url() ?>dashboard/aksi_update_pengajuan_ptsp08/<?= $detail->id_permohonan_ptsp ?>" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<textarea type="text" class="form-control" id="domisili_kelompok_bimbingan" name="domisili_kelompok_bimbingan" value="" placeholder="masukkan domisili kel.bimbingan disini..." required><?= $detail->domisili_kelompok_bimbingan; ?></textarea>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<textarea type="text" class="form-control" id="alamat_kantor" name="alamat_kantor" value="" placeholder="masukkan alamat kantor disini..." required><?= $detail->alamat_kantor; ?></textarea>
									</div>
								</div>
							</div>
							<div class="form-group row">

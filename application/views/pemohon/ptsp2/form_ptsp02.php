				...
				<div class="card-body">
					...
					<form class="form-horizontal mt-4" id="form_ptsp01" enctype="multipart/form-data"
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="date" class="form-control" id="tgl_kegiatan" name="tgl_kegiatan" value=""
										placeholder="masukkan tgl kegiatan disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="waktu_kegiatan" name="waktu_kegiatan" value=""
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="tempat_kegiatan" name="tempat_kegiatan"
										value="" placeholder="masukkan tempat kegiatan disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan"
										value="" placeholder="masukkan nama kegiatan disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="agenda_kegiatan" name="agenda_kegiatan"
										value="" placeholder="masukkan agenda kegiatan disini..." required>
								</div>
							</div>
						</div>
				</div>
			...
			<div class="modal-body">
				...
				<p class="persyaratan mb-0">
					<ol type="1" class="ml-0 list-syarat modal-content-syarat">
						<li>Pemohon membuat surat permohonan ditujukan kepada Kepala Kantor Kementerian Agama Kab.
							Klaten
							ditandatangani oleh panitia yang bersangkutan. Untuk kegiatan Islam diketahui Kepala Desa,
							Kepala KUA, dan Camat.</li>
						<li>Pemohon mengisi formulir dalam aplikasi ini.</li>
						<li>Pemohon mengunggah surat permohonan yang telah dibuat. <br> (Format: PDF, Ukuran: Max 1 MB)
						</li>

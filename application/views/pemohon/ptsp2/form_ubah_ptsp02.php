	...
	<div class="row clearfix">
		...
		<div class="col-xs-12 col-sm-8">
			<div class="card shadow mb-5">
				...
				<div class="card-body">
					<form class="form-horizontal" id="formubah_ptsp01" enctype="multipart/form-data"
						action="<?= base_url() ?>dashboard/aksi_update_pengajuan_ptsp01/<?= $detail->id_permohonan_ptsp ?>"
						method="POST">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="date" class="form-control" id="tgl_kegiatan" name="tgl_kegiatan"
										value="" placeholder="masukkan tgl kegiatan disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="waktu_kegiatan" name="waktu_kegiatan"
										value="" placeholder="contoh: 12.00" required>
								</div>
							</div>
						</div>
						<div class="form-group row">

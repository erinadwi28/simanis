		...
		<div class="row clearfix">
			...
			<div class="col-xs-12 col-sm-8">
				<div class="card shadow mb-5">
					...
					<div class="card-body">
						<form class="form-horizontal" id="formubah_ptsp2" enctype="multipart/form-data" action="<?= base_url() ?>dashboard/aksi_update_pengajuan_ptsp02/<?= $detail->id_permohonan_ptsp ?>" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line">
										<input class="form-control" id="no_hp" name="no_hp" rows="1" placeholder="masukkan no hp disini..." required data-parsley-type="number" minlength="11" value="<?= $detail->no_hp; ?>">
									</div>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="date" class="form-control" id="tgl_kegiatan" name="tgl_kegiatan" value="<?= $detail->tgl_kegiatan; ?>" placeholder="masukkan tgl kegiatan disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="waktu_kegiatan" name="waktu_kegiatan" value="<?= $detail->waktu_kegiatan; ?>" placeholder="contoh: 12.00" required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="tempat_kegiatan" name="tempat_kegiatan" value="<?= $detail->tempat_kegiatan; ?>" placeholder="masukkan tempat kegiatan disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" value="<?= $detail->nama_kegiatan; ?>" placeholder="masukkan nama kegiatan disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line">
										<input type="number" min="1" class="form-control" id="jml_peserta" name="jml_peserta" rows="1" placeholder="masukkan jumlah peserta disini..." required data-parsley-type="number" value="<?= $detail->jml_peserta; ?>">
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="agenda_kegiatan" name="agenda_kegiatan" value="<?= $detail->agenda_kegiatan; ?>" placeholder="masukkan agenda kegiatan disini..." required>
									</div>
								</div>
							</div>
					</div>

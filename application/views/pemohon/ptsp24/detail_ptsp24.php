		...
		<div class="col-md-4 mb-0">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-footer">
					<form action="<?= base_url('dashboard/update_srt_permohonan_ptsp24/' . $detail->id_ptsp) ?>"
			...
			<div class="card shadow mb-4">
				...
				<?php if ($detail->status == 'Pending') { ?>
				<div class="card-footer">
					<form action="<?= base_url('dashboard/update_fc_dokumen_ptsp24/' . $detail->id_ptsp) ?>"
						enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form_upload_fc_dokumen">
						<div class="form-group">
							<div class="input-group">
								<div class="form-group-upload">
									<div class="custom-file">
										<label class="custom-file-label" for="file-upload-2">pilih file...</label>
										<input type="file" class="custom-file-input" id="file-upload-2" name="fc_dokumen"
											value="<?= $detail->fc_dokumen ?>">
										<input type="hidden" class="form-control form-user-input"
											name="id_permohonan_ptsp" id="file-upload"
											value="<?= $detail->id_permohonan_ptsp ?>">
									</div>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-footer">
					<div class="float-right">
						<a href="<?= base_url() ?>dashboard/form_ubah_ptsp24/<?= $detail->id_permohonan_ptsp ?>">

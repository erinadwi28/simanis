			...
			<div class="col-xs col-sm-8">
				<div class="card shadow mb-5">
					...
					<div class="card-body">
						...
						<br>
						<form class="form-horizontal mt-4" id="form_ptsp24" enctype="multipart/form-data" action="<?= base_url('dashboard/aksi_pengajuan_ptsp24') ?>" method="POST">
							<div class="form-group row">
								<label for="pemilik_kendaraan" class="col-sm-3 col-form-label">Pemilik Kendaraan</label>
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="pemilik_kendaraan" name="pemilik_kendaraan" placeholder="masukkan nama disini..." value="<?= $detail->nama; ?>" required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="jml_roda_kendaraan" name="jml_roda_kendaraan" value="" required placeholder="masukkan jumlah roda disini...">
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="merek_kendaraan" name="merek_kendaraan" placeholder="masukkan merek kendaraan disini..." value="" required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="no_polisi" name="no_polisi" value="" placeholder="masukkan no polisi disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="fungsional_kendaraan" name="fungsional_kendaraan" placeholder="masukkan fungsional kendaraan disini..." value="" required>
									</div>
								</div>
							</div>
							<div class="form-group row">

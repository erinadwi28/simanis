		...
		<div class="col-md-4 mb-0">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<center>
						...
						<a id="btn_upload" class="btn btn-sm btn-success"
							href="<?= base_url() ?>./assets/dashboard/pemohon/ptsp/ptsp19/srt_permohonan/<?= $detail->srt_permohonan ?>"
							target="_blank">
				...
				<div class="card-footer">
					<form action="<?= base_url('dashboard/update_srt_permohonan_ptsp19/' . $detail->id_ptsp) ?>"
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<center>
						...
						<a id="btn_upload" class="btn btn-sm btn-success"
							href="<?= base_url() ?>./assets/dashboard/pemohon/ptsp/ptsp19/jadwal_siaran/<?= $detail->jadwal_siaran ?>"
							target="_blank">
							<i class="fa fa-download nav-icon">
							</i> Klik untuk melihat
						</a>
				...
				<?php if ($detail->status == 'Pending') { ?>
				<div class="card-footer">
					<form action="<?= base_url('dashboard/update_jadwal_siaran_ptsp19/' . $detail->id_ptsp) ?>"
						enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form_upload_jadwal_siaran">
						<div class="form-group">
							<div class="input-group">
								<div class="form-group-upload">
									<div class="custom-file">
										<label class="custom-file-label" for="file-upload-2">pilih file...</label>
										<input type="file" class="custom-file-input" id="file-upload-2" name="jadwal_siaran"
											value="<?= $detail->jadwal_siaran ?>">
										<input type="hidden" class="form-control form-user-input"
											name="id_permohonan_ptsp" id="file-upload"
											value="<?= $detail->id_permohonan_ptsp ?>">
									</div>

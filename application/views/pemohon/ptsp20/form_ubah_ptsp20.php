				...
				<div class="card-body">
					<form class="form-horizontal" id="form15" enctype="multipart/form-data"
						...
						<div class="form-group row">
							<label for="nama_majelis_taklim" class="col-sm-3 col-form-label">Nama Majelis Taklim</label>
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="nama_majelis_taklim" name="nama_majelis_taklim" value="" placeholder="masukkan nama majelis taklim disini...">
								</div>
							</div>
						</div>
						<div class="form-group row">

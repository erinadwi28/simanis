	...
	<div class="col-md-4 mb-0">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<center>
						...
						<a id="btn_upload" class="btn btn-sm btn-success"
							href="<?= base_url() ?>./assets/dashboard/pemohon/ptsp/ptsp20/srt_permohonan/<?= $detail->srt_permohonan ?>" target="_blank">
				...
				<div class="card-footer">
					<form action="<?= base_url('dashboard/update_srt_permohonan_ptsp20/' . $detail->id_ptsp) ?>" 
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<center>
						...
						<p><?= $detail->surat_rekomendasi; ?></p>
							<a id="btn_upload" class="btn btn-sm btn-success" href="<?= base_url() ?>./assets/dashboard/pemohon/ptsp/ptsp20/surat_rekomendasi/<?= $detail->surat_rekomendasi ?>" target="_blank">
								<i class="fa fa-download nav-icon">
								</i> Klik untuk melihat
							</a>
				...
				<div class="card-footer">
					...
					enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form_upload_surat_rekomendasi">
							<div class="form-group">
								<div class="input-group">
									<div class="form-group-upload">
										<div class="custom-file">
											<label class="custom-file-label" for="file-upload-2">pilih file...</label>
											<input type="file" class="custom-file-input" id="file-upload-2" name="surat_rekomendasi" 
											value="<?= $detail->surat_rekomendasi ?>">
											<input type="hidden" class="form-control form-user-input" name="id_permohonan_ptsp" id="file-upload" 
											value="<?= $detail->id_permohonan_ptsp ?>">
									</div>
								</div>

		...
		<div class="row clearfix">
			<div class="col-md-4 mb-0">
				...
				<div class="card shadow mb-4">
					...
					<?php if ($detail->status == 'Belum Tuntas') { ?>
						<div class="card-footer">
							<form action="<?= base_url('dashboard/update_srt_permohonan_ptsp16/' . $detail->id_ptsp) ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="formupload_ptsp16_1">
				...
				<div class="card shadow mb-4">
					...
					<?php if ($detail->status == 'Belum Tuntas') { ?>
						<div class="card-footer">
							<form action="<?= base_url('dashboard/update_proposal_ptsp16/' . $detail->id_ptsp) ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="formupload_ptsp16_2">
								<div class="form-group">
									<div class="input-group">
										<div class="form-group-upload col-md-12">
											<div class="custom-file">

			...
			<div class="col-xs col-sm-8">
				<div class="card shadow mb-5">
					...
					<div class="card-body">
						...
						<br>
						<form class="form-horizontal mt-4" id="form_ptsp26" enctype="multipart/form-data" action="<?= base_url('dashboard/aksi_pengajuan_ptsp26') ?>" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="tujuan_permohonan_data" name="tujuan_permohonan_data" value="" required placeholder="masukkan tujuan permohonan data disini...">
									</div>
								</div>
							</div>
						<?php } ?>

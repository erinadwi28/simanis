		...
		<div class="col-md-4 mb-0">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<center>
						...
						<a id="btn_upload" class="btn btn-sm btn-primary"
							href="<?= base_url() ?>./assets/dashboard/pemohon/ptsp/ptsp26/srt_permohonan/<?= $detail->srt_permohonan ?>"
							target="_blank">
				...
				<div class="card-footer">
					<form action="<?= base_url('dashboard/update_srt_permohonan_ptsp26/' . $detail->id_ptsp) ?>"

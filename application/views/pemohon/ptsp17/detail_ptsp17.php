	...
	<div class="row clearfix">
								...
								<div class="input-group">
									<div class="form-group-upload">
										<div class="custom-file">
											...
											<input type="file" class="custom-file-input" id="file-upload-2" name="srt_persetujuan_sekolah_satmikal" value="<?= $detail->srt_persetujuan_sekolah_satmikal ?>">
		...
		<div class="col-xs-12 col-sm-3 mr-5">
			...
			<div class="card shadow mb-4">
				...
				<?php if ($detail->status == 'Pending') { ?>
					<div class="card-footer">
						<form action="<?= base_url('dashboard/update_srt_persetujuan_sekolah_tujuan_ptsp17/' . $detail->id_ptsp) ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="formupload_pts17_3">
							<div class="form-group">
								<div class="input-group">
									<div class="form-group-upload">
										<div class="custom-file">
											<label class="custom-file-label" for="file-upload-3">pilih file...</label>
											<input type="file" class="custom-file-input" id="file-upload-3" name="srt_persetujuan_sekolah_tujuan" value="<?= $detail->srt_persetujuan_sekolah_tujuan ?>">

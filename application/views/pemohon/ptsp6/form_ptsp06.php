		...
		<div class="col-xs col-sm-8">
			<div class="card shadow mb-5">
				...
				<div class="card-body">
					...
					<br>
					<form class="form-horizontal mt-4" id="form_ptsp06" enctype="multipart/form-data"
						action="<?= base_url('dashboard/aksi_pengajuan_ptsp06') ?>" method="POST">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<textarea type="text" class="form-control" id="alamat" name="alamat" value=""
										placeholder="masukkan alamat disini..." required></textarea>
								</div>
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="nama_agen" name="nama_agen" value=""
										placeholder="masukkan nama PPIU/PIHK disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="no_sk_agen" name="no_sk_agen" value=""
										placeholder="masukkan no SK PPIU/PIHK disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">

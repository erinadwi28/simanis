	...
	<?php foreach ($detail_ptsp as $detail) { ?>
		...
		<div class="row clearfix">
									...
									<div class="input-group">
										<div class="form-group-upload col-md-12">
											<div class="custom-file">
												...
												<input type="file" class="custom-file-input" id="file-upload-2" name="formulir" value="<?= $detail->formulir ?>">
												<input type="hidden" class="form-control form-user-input" name="id_permohonan_ptsp" id="file-upload" value="<?= $detail->id_permohonan_ptsp ?>">
											</div>
										</div>
									</div>
			...
			<div class="col-md-8 mb-2">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-center">Rekomendasi ID Masjid & Mushalla</h6>
					</div>
					<div class="card-body">

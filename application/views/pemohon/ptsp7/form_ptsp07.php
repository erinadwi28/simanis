	...
	<div class="d-sm-flex align-items-center justify-content-between">
		...
		<nav aria-label="breadcrumb" class="nav-breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?= base_url('dashboard/sop_ptsp07') ?>">SOP</a></li>
			...
			<div class="col-xs col-sm-8">
				<div class="card shadow mb-5">
					...
					<div class="card-body">
						...
						<br>
						<form class="form-horizontal mt-4" id="form_ptsp07" enctype="multipart/form-data" action="<?= base_url('dashboard/aksi_pengajuan_ptsp07') ?>" method="POST">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ol type="1" class="ml-0 list-syarat modal-content-syarat">
						<li>Pemohon mengunduh Surat Permohonan, unduh dengan <b><a href="<?= base_url() ?>assets/pemohon/sop/ptsp07/srt_permohonan.pdf" target="_blank">[klik disini]</a></b></li>
						...
						<li>Pemohon mengunggah Akte Notaris Pendirian Yayasan. <br> (Format: PDF, Ukuran: Max 1 MB)</li>
						<li>Pemohon mengunggah bukti foto kantor sekretariat tetap dan ruang kegiatan bimbingan. <br> (Format: PDF, Ukuran: Max 10 MB)</li>
						...
						<li>Pemohon mengunggah dokumen rencana program bimbingan manasik. <br> (Format: PDF, Ukuran: Max 1 MB)</li>

			...
			<div class="col-xs col-sm-8">
				<div class="card shadow mb-5">
					...
					<div class="card-body">
						...
						<br>
						<form class="form-horizontal mt-4" id="form_ptsp13" enctype="multipart/form-data" action="<?= base_url('dashboard/aksi_pengajuan_ptsp13') ?>" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="no_srt_pemohon" name="no_srt_pemohon" value="" placeholder="masukkan no surat permohonan disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="date" class="form-control" id="tgl_srt_pemohon" name="tgl_srt_pemohon" value="" required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="hal_srt_pemohon" name="hal_srt_pemohon" value="" placeholder="masukkan hal surat permohonan disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="nama_calon_madrasah" name="nama_calon_madrasah" value="" placeholder="masukkan nama calon madrasah disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<textarea type="text" class="form-control" id="alamat_calon_madrasah" name="alamat_calon_madrasah" value="" placeholder="masukkan alamat instansi pemohon disini..." required></textarea>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="nama_calon_penyelenggara" name="nama_calon_penyelenggara" value="" placeholder="masukkan nama calon penyelenggara disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="akte_notaris" name="akte_notaris" value="" placeholder="masukkan nomor akte notaris disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="form-line focused">
										<input type="text" class="form-control" id="pengesahan_akte_notaris" name="pengesahan_akte_notaris" value="" placeholder="masukkan nomor pengesahan akte notaris disini..." required>
									</div>
								</div>
							</div>
							<div class="form-group row">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ol type="1" class="ml-0 list-syarat modal-content-syarat">
					<li>Pemohon mengunduh Surat Permohonan, unduh dengan <b><a href="https://ijopmadrasah.kemenag.go.id/swasta/pendaftaran/login" target="_blank">[klik disini]</a></b></li>

	...
	<section class="detail-ptsp-title">
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					<h4>Konsultasi dan Informasi Sertifikasi Halal, Zakat dan Wakaf</h4>
				</div>
							...
							<div class="card shadow">
								...
								<div class="card-body">
									<ol type="1" class="ml-3 list">
										...
										<ul  class="ml-4 list">
											<li>Pemohon membuat surat permohonan ditujukan kepada Kepala Kantor
												Kementerian Agama Kab. Klaten</li>
											<li>Pemohon mengunggah surat permohonan yang telah dibuat. <br> (Format:
												PDF, Ukuran: Max 1 MB)</li>
											<li>Pemohon menunggu pemberitahuan dari pihak Kemenag bahwa proses
												permohonan telah selesai.</li>
										</ul>
									</ol>
								</div>
							</div>

	...
	<section class="detail-ptsp-title">
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					<h4>Rekomendasi Proposal PD Pontren (Bantuan Sarpras/Pembangunan/Rehabilitasi Bangunan)</h4>
				</div>
								...
								<div class="card-body">
									<ol type="1" class="ml-3 list">
										<ol type="1" class="ml-0 list-syarat">
											...
											<li>Pemohon mengunggah surat permohonan yang ditujukan kepada Kepala Kemenag
												Kab. Kalten. <br> (Format: PDF, Ukuran: Max 1 MB)</li>
											...
											<ul class="ml-4 list">
												...
												<li>Surat pernyataan membuat LPJ sesuai juknis bermaterai <br>(Format:
													PDF, Ukuran: Max 10 MB)</li>
											</ul>

											<li>Pemohon menunggu pemberitahuan dari pihak Kemenag bahwa proses

	...
	<section class="detail-ptsp-title">
		<div class="container">
			<div class="row text-center">
				<div class="col-md-12">
					<h4>Permohonan Ijin Operasional Majelis Taklim</h4>
				</div>
						...
						<div class="col-md-12 syarat">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<li>Pemohon mengunduh surat permohonan yang ditujukan Kepala Kemenag.</li>
							<li>Pemohon mengunduh surat rekomendasi Kepala KUA Kecamatan.</li>

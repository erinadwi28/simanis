						...
						<div class="col-md-12 syarat">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<li>Pemohon mengunduh surat rekomendasi ditujukan kepada Kepala Kankemenag Kab. Klaten, ditandatangani oleh takmir masjid yang bersangkutan.</li>
							<li>Pemohon mengunduh dan Mengisi Formulir.</li>

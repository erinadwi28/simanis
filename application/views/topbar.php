	...
	<div id="content">
		...
		<!-- Topbar Welcome -->
			<div class="topbar-welcome ml-2">
				<p class="mb-0 ">Halo, Selamat datang !</p>
			</div>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown no-arrow">
					<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $pemohon['nama'] ?></span>
						<img class="img-profile rounded-circle" src="<?= base_url(); ?>./assets/dashboard/images/pemohon/profil/<?= $pemohon['foto_profil_pemohon'] ?>">
					</a>
					<!-- Dropdown - User Information -->
					<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
						<a class="dropdown-item" href="<?= base_url() ?>dashboard/profil_pemohon">

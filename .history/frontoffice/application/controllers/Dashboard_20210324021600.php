...
class Dashboard extends CI_Controller
{
        ...
        public function kirim_alasn_permohonan()
        {
                ...
                // Email penerima
                $this->email->to('jjaffar67@gmail.com'); // Ganti dengan email tujuan
                ...
                // Isi email
                $this->email->message("hehehehe test kak");
                ...
                $email = $this->db->select('pemohon.email')
                ->from('permohonan_ptsp')->join('pemohon', 'permohonan_ptsp.id_pemohon = pemohon.id_pemohon', 'INNER')
                ->where('permohonan_ptsp.id_permohonan_ptsp', $detailhere)->get();

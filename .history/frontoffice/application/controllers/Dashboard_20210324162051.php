...
class Dashboard extends CI_Controller
{
        ...
        public function kirim_alasn_permohonan()
        {
                ...
                // Isi email
                $this->email->message('Halo Pak/Bu '.$email->nama.', <br> Diinformasikan kepada pemohon bahwasannya permohonan anda dipending dikarenakan '.$this->input->post('keterangan').' <br>Salam,<br><br>Kementrian Agama Republik Indonesia');

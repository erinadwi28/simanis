...
class Dashboard extends CI_Controller
{
        ...
        public function kirim_alasn_permohonan()
        {
                ...
                $email = $this->db->select('pemohon.*')->from('permohonan_ptsp')->join('pemohon', 'permohonan_ptsp.id_pemohon = pemohon.id_pemohon', 'INNER')
                ->where('pemohon.id_pemohon', 2)->get();
                // Konfigurasi email
                $config = [
                        'mailtype'  => 'html',
                        'charset'   => 'utf-8',
                ...
                // Email penerima
                $this->email->to($this->$email->email); // Ganti dengan email tujuan

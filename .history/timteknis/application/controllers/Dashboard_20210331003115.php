...
class Dashboard extends CI_Controller
{
    ...
    public function upload_foto_profil()
    {
        ...
        $config['upload_path']          = './../assets/timteknis/profil/';
        ...
        if (!empty($_FILES['berkas']['name'])) {
                if ($this->upload->do_upload('berkas')) {
                        ...
                        $config['source_image'] = './../assets/timteknis/profil/' . $uploadData['file_name'];
                        $config['create_thumb'] = FALSE;
                        $config['maintain_ratio'] = TRUE;
                        $config['quality'] = '100%';
                        $config['width'] = 480;
                        $config['height'] = 640;
                        $config['new_image'] = './../assets/timteknis/profil/' . $uploadData['file_name'];
                        ...
                        if ($item->foto_profil_tim_teknis != "placeholder_profil.png") {
                                $target_file = './../assets/timteknis/profil/' . $item->foto_profil_tim_teknis;
                                unlink($target_file);
                        }

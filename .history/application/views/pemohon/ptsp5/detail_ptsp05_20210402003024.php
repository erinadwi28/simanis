		...
		<div class="col-md-3 mb-4 ml-5" >
			...
			foreach ($detail_ptsp as $detail) { ?>
				...
				<div class="card shadow mb-4">
					...
					<div class="card-footer py-3">
						<?php if ($detail->status == 'Pending') { ?>
							<form action="<?= base_url('dashboard/update_dokumen_ptsp05/' . $detail->id_ptsp) ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form_upload_ijazah">
								<div class="form-group ml-4 mr-2">
									<div class="input-group">
										<div class="form-group-upload">
											<div class="custom-file">
												<label class="custom-file-label" for="file-upload-ktp">pilih file dokumen...</label>
												<input type="file" class="custom-file-input" id="file-upload-surat-permohonan" name="berkas" value="">
												<input type="hidden" class="form-control form-user-input" name="id_permohonan_ptsp" id="id_permohonan_ptsp" value="">
				...
				<div class="card shadow mb-4">
					...
					<div class="card-footer py-3">
							<form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="form_upload_ijazah">
								<div class="form-group ml-4 mr-2">
									<div class="input-group">
										<div class="form-group-upload">
											<div class="custom-file">

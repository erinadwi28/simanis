...
class Dashboard extends CI_Controller
{
    ...
    public function upload_foto_profil()
    {
        ...
        $config['upload_path']          = './assets/images/pemohon/profil/';
        ...
        if (!empty($_FILES['berkas']['name'])) {
            if ($this->upload->do_upload('berkas')) {
                ...
                $config['source_image'] = './assets/images/pemohon/profil/' . $uploadData['file_name'];
                ...
                $config['new_image'] = './assets/images/pemohon/profil/' . $uploadData['file_name'];
                ...
                if ($item->foto_profil_pemohon != "placeholder_profil.png") {
                    $target_file = './assets/images/pemohon/profil/' . $item->foto_profil_pemohon;
                    unlink($target_file);
                }
    ...
    {
        $config['upload_path']          = './assets/pemohon/ptsp/ptsp04/';
        $config['allowed_types']        = 'gif|jpg|png|jpeg|pdf|docx|doc|xlsx|xls';

...
class Masuk extends CI_Controller
{
    ...
    public function aksi_login()
    {
        ...
        if ($captcha_response != '') {
            ...
            if ($finalResponse['success']) {
                ...
                $kasi = $this->m_kasi->cek_email($email, $status_delete);

                if ($kasi) {
                    //kasi ada
                    if ($kata_sandi_hash === $kasi['kata_sandi']) {
                        //kata sandi benar
                    ...
                    //gagal login
                    $this->session->set_flashdata('error', '<b>Email</b> tidak terdaftar sebagai KASI');
                    redirect('masuk');
                }
            } else {
    ...
    public function logout()
    {
        ...
        $this->session->unset_userdata('role_kasi');

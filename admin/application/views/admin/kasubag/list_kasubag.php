...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
			...
			<?php endif ?>
			<!-- btn tambah -->
			<a href="<?= base_url() ?>dashboard/tambah_data_kasubag" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> Tambah
				Data</a>
			<hr>
...
?>
	...
	<div class="modal fade" id="kasubagDeleteModal<?= $data->id_kasubag ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

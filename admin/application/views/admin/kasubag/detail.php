	...
	<div class="d-sm-flex align-items-center justify-content-between">
		...
		<nav aria-label="breadcrumb" class="nav-breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Kasubag</a></li>
		...
		<div class="col-md-4 mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-footer py-3">
                        <form action="<?= base_url('dashboard/upload_foto_profil_kasubag/') ?>" enctype="multipart/form-data" method="POST" accept-charset="utf-8" id="form_upload_foto_profil">
                            <?php
                            foreach ($detail_kasubag as $saya) { ?>

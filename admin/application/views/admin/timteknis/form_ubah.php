...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between">
		<h3 class="judullist py-3">Form Ubah Data Tim Teknis</h3>
	...
	<?php foreach ($detail_timteknis as $data) { ?>
			...
			<div class="card shadow mb-5">
				<div class="card-body">
					<form class="form-horizontal mt-4" id="form_ubah" enctype="multipart/form-data"
						action="<?= base_url('dashboard/aksi_update_timteknis/' . $data->id_tim_teknis) ?>" method="POST">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="sie" name="sie"
										value="<?= $data->sie; ?>" placeholder="<?= $data->sie; ?>" required>
								</div>
							</div>
						</div>
				</div>

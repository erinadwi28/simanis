...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between">
		<h3 class="judullist py-3">Form Ubah Sandi Tim Teknis</h3>
			...
			<div class="row">
				<div class="col-md-12 mb-3">
					<div class="card shadow mb-3">
						<div class="card-body">
							<form role="form" action="<?= base_url('dashboard/aksi_ubah_sandi_timteknis/' . $detail->id_tim_teknis) ?>" method="post"
								id="ubah_pass">
								<div class="row">
                  <div class="col-md-12">

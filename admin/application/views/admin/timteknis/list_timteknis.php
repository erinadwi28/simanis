...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
			...
			<?php endif ?>
			<!-- btn tambah -->
			<a href="<?= base_url() ?>dashboard/tambah_data_timteknis" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
					...
					<?php
						...
						<tr>
							...
							<td class="text-center">
								...
								<a href="#" class="btn btn-tolak btn-sm" data-toggle="modal" data-target="#timteknisDeleteModal<?= $data->id_tim_teknis ?>">
...
<div class="modal fade" id="timteknisDeleteModal<?= $data->id_tim_teknis ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">

...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-body">
			...
			<?php endif ?>
			<!-- btn tambah -->
			<a href="<?= base_url() ?>dashboard/tambah_data_timteknis" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> Tambah
				Data</a>
			<hr>

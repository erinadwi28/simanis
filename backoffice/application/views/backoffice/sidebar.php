    ...
    <li class="nav-item">
      ...
      <div id="menupermohonanptsp" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="<?= base_url('dashboard/list_permohonan_selesaiBO') ?>">Permohonan Selesai</a>
          <a class="collapse-item" href="<?= base_url('dashboard/list_permohonan_prosesKasi') ?>">Peroses Kasi</a>
        </div>
      </div>
    </li>
    <!-- Divider -->

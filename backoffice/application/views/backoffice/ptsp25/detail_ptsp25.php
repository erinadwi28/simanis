		...
		<h3 class="judullist py-3">Detail Permohonan</h1>
			<nav aria-label="breadcrumb" class="nav-breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
					<li class="breadcrumb-item" aria-current="page"><a
							href="<?= base_url('dashboard/list_permohonan_selesaiBO') ?>">Permohonan Selesai BO</a></li>
					<li class="breadcrumb-item active" aria-current="page">Detail</li>
				</ol>
			</nav>
	</div>
	...
	<div class="row clearfix">
				...
				<div class="card-body">
					<center>
						...
						<a id="btn_upload" class="btn btn-sm btn-primary"
							href="<?= base_url() ?>../assets/dashboard/pemohon/ptsp/ptsp25/srt_permohonan/<?= $detail->srt_permohonan ?>"
							target="_blank">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<center>
						<p><?= $detail->jadwal; ?></p>
						<a id="btn_upload" class="btn btn-sm btn-primary"
							href="<?= base_url() ?>../assets/dashboard/pemohon/ptsp/ptsp25/jadwal/<?= $detail->jadwal ?>"
							target="_blank">
							<i class="fa fa-download nav-icon">
							</i> Klik untuk melihat
						</a>
		...
		<div class="col-md-8 mb-0 col-xs-12">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form class="form-horizontal" id="formpetugas_ptsp01" enctype="multipart/form-data"
						action="<?= base_url('dashboard/jadwal_konsultasi') ?>" method="POST">
						<div class="form-group row">
							<label for="hari_konsultasi" class="col-sm-3 col-form-label">Hari Konsultasi</label>
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="hari_konsultasi" name="hari_konsultasi"
										value="" placeholder="masukkan hari disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="date" class="form-control" id="tgl_konsultasi" name="tgl_konsultasi"
										value="" placeholder="masukkan tanggal disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="jam_konsultasi" name="jam_konsultasi"
										value="" placeholder="masukkan jam disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="nama_petugas" name="nama_petugas"
										value="" placeholder="masukkan nama petugas disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="nip_petugas" name="nip_petugas" value=""
										placeholder="masukkan Nip petugas disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="pangkat_golongan"
										name="pangkat_golongan" value=""
										placeholder="masukkan pangkat petugas disini..." required>
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<div class="form-line focused">
									<input type="text" class="form-control" id="jabatan" name="jabatan" value=""
										placeholder="masukkan jabatan petugas disini..." required>
								</div>
							</div>
						</div>
						<?php
								foreach ($detail_ptsp as $detail) { ?>
						<input type="hidden" class="form-control" id="id_ptsp" name="id_ptsp"
							value="<?= $detail->id_ptsp ?>">
						<input type="hidden" class="form-control" id="id_permohonan_ptsp" name="id_permohonan_ptsp"
							value="<?= $detail->id_permohonan_ptsp ?>">
						<input type="hidden" class="form-control" id="id_layanan" name="id_layanan"
							value="<?= $detail->id_layanan ?>">
						<?php } ?>

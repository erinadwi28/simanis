	...
	<div id="content">
		...
		<nav class="navbar navbar-expand navbar-light bg-white topbar static-top shadow mb-3">
			...
			<div class="topbar-welcome ml-2 text-gray-600">
				<i class="fas fa-calendar-alt"></i>&nbsp; <span id="top-info-date" class="top-info-date"></span>&nbsp; | &nbsp;<span class="mb-0 ">Halo, Admin Back Office !</span>
			</div>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown no-arrow">
					<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<img class="img-profile rounded-circle" src="<?= base_url(); ?>../assets/dashboard/images/backoffice/profil/<?= $bo['foto_profil_bo'] ?>">
					</a>
